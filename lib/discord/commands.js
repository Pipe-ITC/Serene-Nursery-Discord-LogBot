...
export const discordCommands = [
  ...
  {
    name: 'ownedby',
    description: 'View logged flowers by player',
    options: [
      {
        type: optionType.USER,
        name: 'player',
  ...
  {
    name: 'cozyplayers',
    description: 'View Cozy players and their pinned flowers',
  },
  {
    name: 'done',
    description: 'Mark your weekly quests as done',
  },
  {
    name: 'addflower',
  ...
  {
    name: 'setflowerimage',
    description: 'Admin: set a flower image',
    options: [
      flowerOption('Flower to update'),
      {
        type: optionType.ATTACHMENT,
        name: 'image',
        description: 'Flower image upload',
        required: true,
      },
    ],
  },
  ...
  {
    name: 'donereset',
    description: 'Admin: clear weekly quest done markers',
  },
  {
