...
const FIRST_BLOOM_STARS_EMOJI = '<a:flashing_stars:1526187016717471825>';
const EXTRA_POINTS_EMOJI = '<a:flashingexclamationemoji:1526190062105264259>';
...
async function handleList(interaction, sql) {
  ...
  if (isFirstGuildLog) {
    return message([
      `${FIRST_BLOOM_STARS_EMOJI} FIRST BLOOM! ${FIRST_BLOOM_STARS_EMOJI}`,
      '',
